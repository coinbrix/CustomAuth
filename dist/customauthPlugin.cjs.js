...
class AbstractLoginHandler {
  ...
  get state() {
    return encodeURIComponent(external_base64url_default().encode(JSON.stringify(objectSpread2_default()(objectSpread2_default()({}, this.customState || {}), {}, {
  ...
  async handleLoginWindow(params) {
    ...
    if (this.uxMode === UX_MODE.REDIRECT) {
      ...
      const {
        BroadcastChannel
      } = await Promise.resolve(/* import() */).then(__webpack_require__.t.bind(__webpack_require__, 378, 23));
      return new Promise((resolve, reject) => {
...
class CustomAuth {
  ...
  async triggerLogin(args) {
    ...
    if (registerOnly) {
      ...
      return objectSpread2_default()(objectSpread2_default()({}, torusPubKey), {}, {
        finalKeyData: objectSpread2_default()(objectSpread2_default()({}, torusPubKey.finalKeyData), {}, {
          privKey: undefined
        }),
        oAuthKeyData: objectSpread2_default()(objectSpread2_default()({}, torusPubKey.finalKeyData), {}, {
          privKey: undefined
        }),
        metadata: objectSpread2_default()(objectSpread2_default()({}, torusPubKey.metadata), {}, {
          nonce: undefined
        }),
    ...
    return objectSpread2_default()({}, torusKey);
  }
  ...
  async triggerHybridAggregateLogin(args) {
    ...
    return {
      singleLogin: objectSpread2_default()({}, torusKey1),
  ...
  async getTorusKey(verifier, verifierId, verifierParams, idToken, additionalParams) {
    ...
    const sharesResponse = await this.torus.retrieveShares(nodeDetails.torusNodeEndpoints, nodeDetails.torusIndexes, verifier, verifierParams, idToken, objectSpread2_default()({}, additionalParams));
  ...
  async getRedirectResult() {
    ...
    const _await$this$storageHe = await this.storageHelper.retrieveLoginDetails(instanceId),
      ...
      rest = objectWithoutProperties_default()(_await$this$storageHe, _excluded3);
...
/******/ })()
;
//# sourceMappingURL=customauthPlugin.cjs.js.map